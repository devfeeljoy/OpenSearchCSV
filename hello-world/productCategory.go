...
func main() {
	...
	urlOpus := openSearchURL + "/products/_search"
	urlCategories := openSearchURL + "/product_categories/_search"
	...
	// CSV 파일 생성 및 저장
	file, err := os.Create("/Users/joupil/Desktop/highdev/뷰릿지/OpenSearchCSV/csv/누락된_상품_카테고리.csv")
	if err != nil {
